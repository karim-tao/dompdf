...
CSS;
    ...
    public function testRemainingHeightGoesToThePercentageRowsWhenThereIsNoAutoRow(): void
    {
        [$boxes] = $this->layout("<table style=\"height: 100pt\"><tr style=\"height: 20%\"><td id=\"a\">a</td></tr><tr style=\"height: 60%\"><td id=\"b\">b</td></tr></table>");

        $this->assertEqualsWithDelta(25.0, $boxes["a"]["h"], 0.01);
        $this->assertEqualsWithDelta(75.0, $boxes["b"]["h"], 0.01);
    }

    public function testRowsWithFixedHeightsOnlyGrowInProportionToTheirHeight(): void
    {
        ...
        $this->assertEqualsWithDelta(80.0, $boxes["b"]["h"], 0.01);
    }
